...
const dlMode = () => {
  ...
  if (current === 'light') {
    ...
    document.querySelector('body').style.setAttribute('style', 'background-color: #000000')
    mode = 'dark'
    ...
    document.querySelector('body').style.setAttribute('style', 'background-color: #ededed')
